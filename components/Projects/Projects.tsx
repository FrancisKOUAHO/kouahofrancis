                            ...
                            return (
                                <div className="flex-1 fadeup-enter fadeup-enter-done" style={{transitionDelay: "0ms"}}
                                    ...
                                    <div
                                        ...
                                        <div className="flex justify-between items-center"><p className="text-2xl">🎲</p>
                                            <div className="flex gap-2"><a
                                                href="https://github.com/Melvynx/random-student"
                                            ...
                                            </a><a href="https://random-student.vercel.app/"
                                                   className="ProjectCard_iconWrapper__rhgv1">
